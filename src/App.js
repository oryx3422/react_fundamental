...
function App() {
  const [posts, setPosts] = useState([
    { id: 1, title: "3 JavaScript", body: "4 Язык программирования" },
    { id: 2, title: "2 JavaScript", body: "5 Язык программирования" },
    { id: 3, title: "1 JavaScript", body: "6 Язык программирования" },
  ]);
